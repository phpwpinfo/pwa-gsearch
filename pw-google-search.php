...
class pwGoogleSearch{
    ...
    private $pw_gsearch_id;
     ...
     public function __construct() {
        ...
        $this->pw_gsearch_id = $options['pw_gsearch_id'];
        $this->pw_gsearch_page_url = $options['pw_gsearch_page_url'];
    }
    
    function pw_add_gsearch(){
       ?>
             <form id="searchbox" action="<?php echo $this->pw_gsearch_page_url ?>" class="gsearch-form">
                <input type="hidden" name="cx" value="<?php echo $site_vars['searchid']; ?>" />
